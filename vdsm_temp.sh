...
VDSM_DIR="/mnt/virtual-dsm"
VDSM_PID="/var/run/$VDSM_NAME.pid"
VDSM_LOG="$VDSM_DIR/log.log"
VDSM_CONFIG="$VDSM_DIR/config.cfg"
VDSM_CPU="host"
VDSM_DISPLAY="none"
VDSM_PORT_SOCKET="12345"

### host.bin configs
VDSM_H_API_CMD=6
VDSM_H_APIT_TIMEOUT=50
VDSM_H_API_PORT="2210"
VDSM_H_API_HOST="127.0.0.1:$VDSM_H_API_PORT"
VDSM_H_PROG="$VDSM_DIR/host.bin"
VDSM_H_PID="/var/run/${VDSM_NAME}_host.pid"
VDSM_H_CPU=2
